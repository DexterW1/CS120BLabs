 ...
 * reset all leds
 */
void ld_resetmatrix(uint8_t ledmatrix) {
	uint8_t j = 0;
	for(j=0; j<8; j++) {
 ...
 * reset a led matrix
 */
void ld_setmatrix(uint8_t ledmatrix, uint8_t rows[8]) {
	uint8_t j = 0;
 ...
 * set a ledmatrix row
 */
void ld_setrow(uint8_t ledmatrix, uint8_t col, uint8_t row) {
 ...
 */
void ld_setled(uint8_t ledmatrix, uint8_t lednum, uint8_t status) {
	if(lednum < 64) {
 ...
 */
void ld_setledon(uint8_t ledmatrix, uint8_t lednum) {
	ld_setled(ledmatrix, lednum, 1);
}
 ...
 * set a ledmatrix led on
 */
void ld_setledoff(uint8_t ledmatrix, uint8_t lednum) {
	ld_setled(ledmatrix, lednum, 0);
}
 ...
 */
void ld_setintensity(uint8_t ledmatrix, uint8_t intensity) {
